...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        # 0 C = +
        buttons = [
            ('7', 0, 0), ('8', 0, 1), ('9', 0, 2), ('/', 0, 3),('Light', 0, 4, 2,1),
            ('4', 1, 0), ('5', 1, 1), ('6', 1, 2), ('*', 1, 3),
            ('1', 2, 0), ('2', 2, 1), ('3', 2, 2), ('-', 2, 3),('Dark', 2, 4, 2,1),
            ('0', 3, 0), ('C', 3, 1), ('.', 3, 2), ('+', 3, 3),
            ('=', 4, 0, 1, 4), ('Contrast', 4,4,1,1 ) # (... 1, 4) bedeutet: soll sich über 1 Zeile und 4 Spalten erstrecken
        ]
