...
class OnlineShop:
    ...
    def produktInListe(self, produktname):
        ...
        if produkt_nicht_enthalten:
            print(f" {produktname} (noch) nicht in Liste enthalten!")
            return False
    
    def __addProduct(self, name, preis):
    ...
    def KapselungAddProduct(self, name, preis):
        self.__addProduct(name, preis)
...
# AttributeError
# mein_shop.__addProduct("Laptop")

mein_shop.KapselungAddProduct("Xiaomi", 500)
